void get_value_innen ()
{
  ...
  if (isnan(event.temperature))
   {
    Serial.println("Error reading temperature inside!");
    Serial.println();
    Serial.println();
  ...
  {
    Serial.println( "Error reading humidity inside!");
    Serial.println();
    Serial.println();
  ...
  else
  {
   ...
   Serial.print  (String(temp_innen)+"°C");
   Serial.println();
   Serial.print  (("luftfeuchtigkeit: "));
   Serial.print  (String(hum_innen)+"%");
   Serial.println();
   Serial.println();
  }
}