void get_value_aussen ()
{
 ...
 // sensordaten lesen temperatur
  ...
  if (isnan(event.temperature))
   {
    Serial.println("Error reading temperature outside!");
    Serial.println();
    Serial.println();
  ...
  {
    Serial.println("Error reading humidity outside!");
    Serial.println();
    Serial.println();
  ...
  Serial.print  (String(temp_aussen)+"°C");
  Serial.println();
  
  Serial.print  (("luftfeuchtigkeit: "));
  Serial.print  (String(hum_aussen)+"%");
